package one.rarebit.voidbind.app.ui.theme
 ...
 */
private val VoidbindDarkColorScheme = darkColorScheme(
...
fun VoidbindTheme(
    ...
    MaterialTheme(
        colorScheme = VoidbindDarkColorScheme,
        typography = VoidbindTypography,
        content = content,
    )
}
